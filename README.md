# 365 AI Engineer Bootcamp — o'zbekcha darslik

> **Manba kurs:** *The AI Engineer Course 2025: Complete AI Engineer Bootcamp* (365 Careers, Udemy)
> Har bir modul mos `.vtt` transkriptlardan tayyorlangan, amaliy topshiriqlar, grafikalar va Python misollari bilan boyitilgan.
...
| 75 | AI etikasi: ChatGPT etikasi | — | ⏳ Navbatda |
...
**Nimani beradi:** AI, ML, DL va Data Science ni bir umrga chalkashtirmaslik.

| Dars | Mavzu |
|---|---|
| 1 | [5 daqiqada AI vositasini yaratish — demo](01-Intro-to-AI-Getting-Started/01-Building-an-AI-tool-in-5-minutes.md) |
| 2 | [Kurs nimalarni qamrab oladi](01-Intro-to-AI-Getting-Started/02-What-does-the-course-cover.md) |
| 3 | [Tabiiy va sun'iy intellekt](01-Intro-to-AI-Getting-Started/03-Natural-vs-Artificial-Intelligence.md) |
| 4 | [AI ning qisqacha tarixi](01-Intro-to-AI-Getting-Started/04-Brief-history-of-AI.md) ⭐ |
| 5 | [AI, DS, ML va DL farqi](01-Intro-to-AI-Getting-Started/05-Demystifying-AI-DS-ML-DL.md) ⭐ |
| 6 | [Weak vs Strong AI (AGI)](01-Intro-to-AI-Getting-Started/06-Weak-vs-Strong-AI.md) |

---

## 🧭 Modul 02 — Ma'lumot

**Nimani beradi:** rasm, ovoz va video kompyuter uchun nima ekanini tushunish.

| Dars | Mavzu |
|---|---|
| 1 | [Strukturalangan va strukturalanmagan ma'lumot](02-Data-is-essential-for-building-AI/01-Structured-vs-unstructured-data.md) |
| 2 | [Ma'lumotni qanday to'playmiz](02-Data-is-essential-for-building-AI/02-How-we-collect-data.md) 💻 |
| 3 | [Belgilangan va belgilanmagan ma'lumot](02-Data-is-essential-for-building-AI/03-Labelled-and-unlabelled-data.md) 💻 |
| 4 | [Metadata — ma'lumotni tavsiflovchi ma'lumot](02-Data-is-essential-for-building-AI/04-Metadata-Data-that-describes-data.md) 💻 🔒 |

💻 = Python amaliyoti bor · 🔒 = xavfsizlik bo'limi bor

---

## 🧭 Modul 03 — AI qanday o'rganadi

**Nimani beradi:** "neyron tarmoq" iborasidan qo'rqmaslik — uni sxema chizib tushuntira olish.

| Dars | Mavzu |
|---|---|
| 1 | [Machine Learning](03-Key-AI-techniques/01-Machine-learning.md) 💻 |
| 2 | [Supervised, Unsupervised, Reinforcement](03-Key-AI-techniques/02-Supervised-Unsupervised-Reinforcement.md) 💻 |
| 3 | [Deep Learning](03-Key-AI-techniques/03-Deep-learning.md) ⭐ 💻 |
...
## 🧭 Modul 17 — Ketma-ketliklar

**Nimani beradi:** ma'lumotni tashkil qilish — bitta o'zgaruvchida yuzlab qiymat.

| Dars | Mavzu |
|---|---|
| 1 | [Ro'yxatlar](17-Sequences/01-Lists.md) ⭐ |
| 2 | [Metodlar](17-Sequences/02-Using-Methods.md) ⭐ |
| 3 | [Kesish (slicing)](17-Sequences/03-List-Slicing.md) ⭐ |
| 4 | [Tuple lar](17-Sequences/04-Tuples.md) |
| 5 | [Lug'atlar](17-Sequences/05-Dictionaries.md) ⭐ |

📝 **[72 ta mashq](17-Sequences/MASHQLAR.md)** · 🚀 **[6 ta mini-loyiha](17-Sequences/LOYIHALAR.md)**
...
Har bir darsda uch daraja bor:

| Belgi | Daraja | Vaqt |
|---|---|---|
| 🟢 | Oson — asosiy tushunchani mustahkamlaydi | 5–10 daq |
| 🟡 | O'rta — real hayotga bog'laydi | 15–20 daq |
| 🔴 | Qiyin — mini-loyiha yoki muhokama | 20–40 daq |

> Faqat video ko'rish "tushundim" hissi beradi. Bu **tushunish emas — tanish bo'lish**.

### 3. O'zini tekshirish savollariga javob bering

Javoblar `<details>` blokida yopiq turadi. **Avval o'zingiz javob bering**, keyin oching.

### 4. Grafikalarga qarang

Har bir `assets/*.svg` faylni brauzerda yoki VS Code'da ochish mumkin. Ular matnni takrorlamaydi — **boshqacha ko'rsatadi**.

---

## 💻 Python haqida

Barcha Python misollari **hech qanday kutubxona o'rnatmasdan** ishlaydi — faqat Python kerak.

```bash
python --version
```

Agar chiqmasa: [python.org](https://www.python.org/downloads/) dan yuklab oling va **"Add Python to PATH"** katakchasini belgilang.
...
├── 01-Intro-to-AI-Getting-Started/
│   ├── README.md                      ← modul indeksi
│   ├── 01..06-*.md                    ← 6 ta dars
│   └── assets/                        ← 9 ta SVG grafika
├── 02-Data-is-essential-for-building-AI/
│   ├── README.md
│   ├── 01..04-*.md                    ← 4 ta dars
