  ...
  questions: [
    {
      ...
      options: [
        ...
        "Pozitsion embeddinglar — har epoxada yangi raqamlar beriladi",
        "Bashorat qilish tartibi — so'zlar joyida qoladi, kim kimni ko'rishi o'zgaradi",
        "Lug'at — har batch uchun boshqa tokenlar to'plami tanlanadi"
      ],
      answer: [2],
    ...
    },
    {
      ...
      type: "single",
      options: [
        "cleaner emojilarni qoldiradi; tuzatish — no_emoji=False berish",
        "cased model harf farqini biladi, cleaner esa hammasini kichik qildi; tuzatish — lower=False",
        "cased model faqat kichik harflarni tushunadi; tuzatish — matnni oldindan kichik qilish",
        "cleaner @ belgisini qoldiradi; tuzatish — re.sub bilan @ ni olib tashlash"
      ],
      answer: [1],
    ...
    },
    {
      ...
      type: "single",
      options: [
        "max_length=64 — hech narsa kesilmaydi va e'tibor O(n²) bo'lgani uchun taxminan 4× tezroq",
        "max_length=32 — o'rtacha uzunlik 24 bo'lgani uchun eng tez va eng aniq variant",
        "max_length=128 qoldirish — 128 transformerlar uchun standart qiymat",
        "max_length=256 — kattaroq qiymat modelga ko'proq kontekst beradi"
      ],
      answer: [0],
    ...
    },
    {
      ...
      options: [
        ...
        "Kod TypeError beradi, chunki XLNet'da indeks 0 mavjud emas",
        "Jim noto'g'ri ishlaydi: indeks 0 da <pad>, <cls> esa oxirgi pozitsiyada",
        "Kod to'g'ri ishlaydi, faqat <sep> vektori olinadi"
      ],
      answer: [2],
    ...
    },
    {
      ...
      type: "single",
      options: [
        "Model fayli buzilgan, uni qayta yuklab olish kerak",
        "Normal holat: til modeli boshi tashlandi, tasnif boshi tasodifiy qiymatlar bilan yangidan yaratildi",
        "num_labels noto'g'ri berilgan, u 2 bo'lishi kerak edi",
    ...
    },
    {
      ...
      options: [
        ...
        "id2label berilmagani uchun model yorliqlarni aralashtirib yubordi",
        ...
        "max_length=128 matnlarning yarmini kesib tashladi"
      ],
      answer: [0, 2, 3],
    ...
    },
    {
      ...
      type: "single",
      options: [
        "Model joy sinfini yodlab olgan, chunki unda eng ko'p misol bor",
        ...
        "Model ijobiy va salbiyni ajratdi, lekin salbiy hissiyotlarni bir-biridan ajrata olmaydi"
      ],
      answer: [3],
    ...
    },
    {
      ...
      options: [
        ...
        "Tozalash bitta funksiyada bo'lsin va o'qitishda ham, bashoratda ham o'sha funksiya chaqirilsin",
        "Bashorat uchun alohida, kuchliroq tozalash funksiyasi yozish kerak"
      ],
      answer: [2],
