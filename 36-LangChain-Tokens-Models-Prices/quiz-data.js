  ...
  questions: [
    {
      ...
      type: "single",
      options: [
        "[30] — \"?\" tez-tez uchraydi, BPE lug'ati chastota bo'yicha quriladi",
        "[63] — \"?\" ning ASCII kodi token ID sifatida ishlatiladi",
        "[30] — tinish belgilari lug'atda alifbo tartibida birinchi turadi",
        "[] — tinish belgilari alohida tokenga aylanmaydi"
      ],
      answer: [0],
    ...
    },
    {
      ...
      type: "single",
      options: [
        "Katta harflarni kichikka o'tkazish har doim token tejaydi va sifatga zarar qilmaydi",
        "GPT tokenizatori bo'shliqlarni butunlay tashlab yuboradi, shuning uchun ular muhim emas",
        "Bo'shliq va katta harf token qismi: \"salom\" va \" salom\" turli tokenlar, ortiqcha bo'shliq qo'ymang",
        "Bir so'zning ID'si jumladagi o'rniga qarab tasodifiy tanlanadi"
      ],
      answer: [2],
    ...
    },
    {
      ...
      type: "single",
      options: [
        "Kurs xato qilgan, narx hisobida doim 90 raqamini ishlatish kerak",
        "Kurs ehtiyotkor: narxni kam baholagandan ko'ra ko'p baholash xavfsizroq",
        "Farq tiktoken xatosidan kelib chiqqan, haqiqiy nisbat doim 75",
        "Nisbat faqat modelga bog'liq, matn turiga bog'liq emas"
      ],
      answer: [1],
    ...
    },
    {
      ...
      options: [
        ...
        "So'z darajasida lug'at juda katta bo'ladi va noma'lum so'z <unk> ga aylanadi",
        "BPE lug'at hajmi va ketma-ketlik uzunligi o'rtasida muvozanat beradi",
        "Harf darajasida ko'p so'zlar <unk> bo'lib qoladi",
        "So'z darajasida ketma-ketlik eng uzun bo'ladi"
      ],
      answer: [0, 1, 2],
    ...
    },
    {
      ...
      options: [
        ...
        "Ikkalasida ham taxminan 1.1× — farq sezilmaydi",
        "cl100k da 2.5×, o200k da 2.5× — lug'at hajmi ta'sir qilmaydi",
        "cl100k da 1.88×, o200k da 1.66× — gpt-4o oilasi o'zbekcha uchun arzonroq"
      ],
      answer: [3],
    ...
    },
    {
      ...
      options: [
        ...
        "Agglutinatsiya: qo'shimchalar yopishib, har so'z noyob bo'lib qoladi",
        "Lug'atda o'zbekcha bo'laklar deyarli yo'q",
        "Tokenizator lotin yozuvini emas, faqat kirillni taniydi",
        "o200k lug'ati cl100k dan kichikroq"
      ],
      answer: [0, 1, 2],
    ...
    },
    {
      ...
      type: "single",
      options: [
        "~61 ming so'z — inglizchaga nisbatan deyarli yarim, shuning uchun RAG kerak",
        "~115 ming so'z — til oyna hajmiga ta'sir qilmaydi",
        "~230 ming so'z — o'zbekcha so'zlar qisqa bo'lgani uchun ko'proq sig'adi",
        "~8 ming so'z — oyna faqat kirish uchun ajratilgan"
      ],
      answer: [0],
    ...
    },
    {
      ...
      options: [
        ...
        "O'qitish ma'lumotining cut-off sanasi",
        "Kontekst oynasi chegarasi",
        "Modeldagi parametrlar soni",
    ...
    },
    {
      ...
      options: [
        ...
        "Chunki embedding faqat birinchi 1000 tokenni o'qiydi",
        "Chunki text-embedding-3-small arzon ($0.02) va bir marta hisoblanib saqlanadi"
      ],
      answer: [3],
